...
String _$profileHash() => r'224650d9a152ec426e878ed59d5880467e4d56b8';
...
abstract class _$Profile
    extends BuildlessAutoDisposeAsyncNotifier<UserProfileEntity> {
...
/// See also [Profile].
class ProfileFamily extends Family<AsyncValue<UserProfileEntity>> {
  /// See also [Profile].
  const ProfileFamily();
...
class ProfileProvider
    extends AutoDisposeAsyncNotifierProviderImpl<Profile, UserProfileEntity> {
  /// See also [Profile].
  ProfileProvider(
    String userId,
  ) : this._internal(
  ...
  @override
  FutureOr<UserProfileEntity> runNotifierBuild(
  ...
  @override
  AutoDisposeAsyncNotifierProviderElement<Profile, UserProfileEntity>
      createElement() {
...
mixin ProfileRef on AutoDisposeAsyncNotifierProviderRef<UserProfileEntity> {
  /// The parameter `userId` of this provider.
  String get userId;
}

class _ProfileProviderElement
    extends AutoDisposeAsyncNotifierProviderElement<Profile, UserProfileEntity>
    with ProfileRef {
