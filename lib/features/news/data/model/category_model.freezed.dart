...
class _$CategoryModelImpl extends _CategoryModel {
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, name: $name, label: $label, icon: $icon, order: $order, isActive: $isActive)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, label, icon, order, isActive);
...
abstract class _CategoryModel extends CategoryModel {
  const factory _CategoryModel(
      ...
      @HiveField(5) final bool isActive}) = _$CategoryModelImpl;
